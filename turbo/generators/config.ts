...
export default function generator(plop: PlopTypes.NodePlopAPI): void {
  plop.setGenerator("New package", {
    description: "Generate a new package for @repo",
    prompts: [
      {
        type: "input",
        name: "name",
  ...
  plop.setGenerator("New NextJS app", {
    description: "Generate a new NextJS app",
    prompts: [
      {
        type: "input",
        name: "name",
    ...
    actions: [
      ...
      },
      {
        type: "add",
        path: "packages/{{ name }}/eslint.config.js",
        templateFile: "templates/eslint.config.app.js.hbs",
      },
      {
        type: "add",
        path: "packages/{{ name }}/package.json",
        templateFile: "templates/package.app.json.hbs",
      },
      {
        type: "add",
        path: "packages/{{ name }}/tsconfig.json",
